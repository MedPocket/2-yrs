...
- **Rối loạn chức năng bánh nhau / Thai nhi:** Thai chậm phát triển trong tử cung (_Fetal Growth Restriction_ - FGR), siêu âm Doppler động mạch rốn bất thường, hoặc thai chết lưu trong tử cung.[^1][^2]
...
2. **Tổn thương tế bào nội mạc lan tỏa và rối loạn đa cơ quan:**
   ...
   - **Não:** Rối loạn tự điều hòa tuần hoàn não, phá vỡ hàng rào máu - não gây phù não, co giật (Sản giật) và xuất huyết não.[^2][^4]
...
### Vai trò của Tỷ lệ sFlt-1/PlGF trong chẩn đoán và tiên đoán

Đo nồng độ sFlt-1 và PlGF trong huyết thanh mẹ có giá trị lâm sàng lớn trong việc tiên đoán và loại trừ tiền sản giật ở các thai phụ nghi ngờ:[^1]

- **Ngưỡng sFlt-1/PlGF ≤ 38 (Nghiên cứu PROGNOSIS):** Cho phép **loại trừ** khả năng phát triển tiền sản giật trong vòng 1 tuần với Giá trị tiên đoán âm (_Negative Predictive Value_ - NPV) đạt **99.3%**, và loại trừ trong vòng 4 tuần với NPV đạt **94.3%**. Giúp tránh chỉ định nhập viện không cần thiết.[^1]
- **Ngưỡng sFlt-1/PlGF > 38:** Cần được theo dõi sát và đánh giá lại sau 1 - 2 tuần.
- **Ngưỡng sFlt-1/PlGF > 85 (khi thai < 34 tuần) hoặc > 110 (khi thai ≥ 34 tuần):** Tiên đoán nguy cơ rất cao xuất hiện các biến chứng nặng ở mẹ và thai nhi trong vòng 4 tuần; hỗ trợ khẳng định chẩn đoán tiền sản giật trong các trường hợp lâm sàng phức tạp.[^1]
...
- **Hội chứng HELLP:** Thể lâm sàng đặc biệt nghiêm trọng của tiền sản giật bao gồm Tán huyết tự miễn biến đổi hình thái hồng cầu (_Hemolysis_), Tăng men gan (_Elevated Liver enzymes_) và Giảm tiểu cầu (_Low Platelets_ < 100 000/µL).
...
Chỉ định điều trị hạ áp ngay lập tức khi Huyết áp tâm thu **≥ 160 mmHg** và/hoặc Huyết áp tâm trương **≥ 110 mmHg** để phòng ngừa biến chứng xuất huyết não và tử vong mẹ.[^3][^4]
...
- **Các thuốc hạ áp an toàn trong thai kỳ:**
  - **_Labetalol_:** Thuốc chẹn alpha-1 và beta không chọn lọc.
    - _Cấp cứu (Tĩnh mạch):_ Khởi đầu **20 mg** tiêm tĩnh mạch chậm trong 2 phút. Lặp lại **40 - 80 mg** mỗi 10 phút nếu chưa đạt mục tiêu (liều tối đa tích lũy **300 mg**). Hoặc truyền tĩnh mạch **1 - 2 mg/phút**.
    - _Duy trì (Uống):_ **100 - 400 mg** x 2 - 3 lần/ngày (liều tối đa **2400 mg/ngày**).
  - **_Nifedipin_:** Thuốc chẹn kênh Calcium nhóm Dihydropyridine.
    - _Cấp cứu (Uống tác dụng nhanh):_ **10 - 20 mg** uống (không nhai, không ngậm dưới lưỡi). Lặp lại sau 30 phút nếu cần.
    - _Duy trì:_ _Nifedipin_ phóng thích kéo dài (Retard/Chrono) **30 - 60 mg** x 1 - 2 lần/ngày (liều tối đa **120 mg/ngày**).
  - **_Hydralazine_:** Thuốc giãn mạch trực tiếp.
    - _Cấp cứu (Tĩnh mạch):_ **5 - 10 mg** tiêm tĩnh mạch chậm trong 2 phút. Lặp lại **5 - 10 mg** sau 20 - 30 phút nếu cần (liều tối đa **20 mg**).
  - **_Methyldopa_:** Thuốc tác động lên alpha-2 agonist trung ương. Liều **250 - 500 mg** x 2 - 4 lần/ngày (liều tối đa **3000 mg/ngày**). Thuốc an toàn nhưng tác dụng hạ áp chậm.[^4]
...
- **Phác đồ tiêm truyền tĩnh mạch (Zuspan scheme):**
  - **Liều tấn công (Loading dose):** **4 - 6 g** _magnesium sulfate_ 20% pha trong 100 mL dung dịch $NaCl$ 0.9% truyền tĩnh mạch trong **15 - 20 phút**.
...
- **Tuổi thai 24⁰/₇ đến 33⁶/₇ tuần (Tiền sản giật có dấu hiệu nặng):**
  ...
  - **Chỉ định chấm dứt thai kỳ cấp cứu không trì hoãn (dù ở bất kỳ tuổi thai nào)** khi xuất hiện:
    - Tăng huyết áp không kiểm soát được bằng thuốc.
    - Sản giật, Phù phổi cấp, Mất thị giác, Xuất huyết não.
    - Hội chứng HELLP tiến triển, Suy thận cấp tiến triển.
    - Rau bong non, Thai suy cấp hoặc Thai chết lưu.[^3][^4]
...
- **Liều dùng:** **75 - 150 mg/ngày** (FIGO khuyến cáo liều **150 mg/ngày** uống vào buổi tối).[^1]
