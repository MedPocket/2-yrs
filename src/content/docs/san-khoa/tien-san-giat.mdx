...
_Hình "Tổng quan về tiền sản giật: Định nghĩa và ảnh hưởng đa cơ quan đối với mẹ và thai nhi"_. Nguồn: FIGO (2019) & AHA Circulation (2022).
...
_Hình "Mô hình 2 giai đoạn và sự mất cân bằng các yếu tố mạch máu trong cơ chế bệnh sinh của tiền sản giật"_. Nguồn: AHA Circulation (2022).
...
2. **Tổn thương tế bào nội mạc lan tỏa và rối loạn đa cơ quan:**
   ...
   - **Thần kinh:** Rối loạn tự điều hòa tuần hoàn, phá vỡ hàng rào máu - brain gây phù, co giật (Sản giật) và xuất huyết não.[^2][^4]
...
## Theo dõi và Điều trị Sau sinh

Giai đoạn hậu sản là thời điểm then chốt nhưng thường bị bỏ sót trong quản lý tiền sản giật. Khoảng **30%** các trường hợp sản giật và nhiều biến chứng nặng xảy ra trong thời kỳ hậu sản (đặc biệt trong 48 giờ đầu và đến 6 tuần sau sinh).[^2][^3][^4]

### Theo dõi và Quản lý Nội viện (Postpartum Inpatient Care)

1. **Duy trì dự phòng co giật bằng Magnesium Sulfate ($MgSO_4$):**
   - Tiếp tục truyền tĩnh mạch duy trì $MgSO_4$ **1 - 2 g/giờ** trong **ít nhất 24 giờ sau sinh** (hoặc 24 giờ sau cơn co giật cuối cùng) cho tất cả bệnh nhân tiền sản giật có dấu hiệu nặng để ngừa sản giật hậu sản.[^3][^4]
2. **Theo dõi Huyết áp và Triệu chứng lâm sàng:**
   - Đo huyết áp ít nhất mỗi **4 giờ** trong thời gian nằm viện.[^3]
   - Theo dõi sát các triệu chứng báo động thần kinh: đau đầu dữ dội, rối loạn thị giác (nhìn mờ, ám điểm), đau vùng thượng vị/hạ sườn phải, phù tiến triển.[^3][^4]
3. **Chỉ định Thuốc Hạ áp Sau sinh:**
   - Bắt đầu hoặc tiếp tục điều trị hạ áp bằng đường uống nếu Huyết áp tâm thu **≥ 150 mmHg** và/hoặc Huyết áp tâm trương **≥ 100 mmHg** ở 2 lần đo cách nhau ít nhất 4 giờ.[^2][^3]
   - Nếu huyết áp **≥ 160/110 mmHg**, cần xử trí hạ áp cấp cứu ngay lập tức trong vòng 30 - 60 phút bằng _Labetalol_ IV, _Nifedipin_ uống, hoặc _Hydralazine_ IV.[^3][^4]
   - **Lựa chọn thuốc hạ áp an toàn cho phụ nữ cho con bú:**
     - _Labetalol_ (uống): **100 - 400 mg** x 2 - 3 lần/ngày.[^2][^4]
     - _Nifedipin_ tác dụng kéo dài (uống): **30 - 60 mg** x 1 - 2 lần/ngày.[^2][^4]
     - _Enalapril_ hoặc _Captopril_ (Thuốc ức chế men chuyển - ACEi): Có thể sử dụng an toàn ở giai đoạn sau sinh cho phụ nữ cho con bú (nồng độ trong sữa mẹ rất thấp), không còn chống chỉ định như trong lúc mang thai.[^2][^4]
4. **Lưu ý sử dụng thuốc giảm đau NSAIDs:**
   - Cần cẩn trọng khi sử dụng các thuốc giảm đau kháng viêm không steroid (NSAIDs như _Ibuprofen_) ở sản phụ bị tăng huyết áp khó kiểm soát, suy thận hoặc giảm tiểu cầu. Tuy nhiên, theo khuyến cáo ACOG, NSAIDs có thể sử dụng ưu tiên cho đau hậu phẫu/hậu sản trừ khi có suy thận tiến triển hoặc huyết áp không kiểm soát.[^3]

### Tiêu chuẩn Xuất viện và Theo dõi Ngoại viện (Outpatient Follow-up)

1. **Tiêu chuẩn xuất viện:**
   - Huyết áp được kiểm soát ổn định **< 150/100 mmHg** trong ít nhất 24 - 48 giờ.
   - Không còn triệu chứng lâm sàng báo động (đau đầu, rối loạn thị giác, đau hạ sườn phải).
   - Các xét nghiệm cận lâm sàng (tiểu cầu, men gan, creatinine) ổn định hoặc đang có xu hướng hồi phục.[^3][^4]
2. **Theo dõi huyết áp ngoại viện (Home BP Monitoring):**
   - Đo và ghi nhận huyết áp tại nhà **1 - 2 lần/ngày**.[^3]
   - Khám lại vào **ngày thứ 7 - 10 sau sinh** (hoặc sớm hơn từ 3 - 5 ngày nếu có dấu hiệu bất thường) để kiểm tra huyết áp và điều chỉnh liều thuốc hạ áp.[^3][^4]
   - Giảm liều và ngưng dần thuốc hạ áp khi huyết áp trở lại bình thường (thường trong vòng 1 - 6 tuần sau sinh).
3. **Chẩn đoán Tiền sản giật Khởi phát Muộn Sau sinh (_Late-onset Postpartum Preeclampsia_):**
   - Xuất hiện từ **48 giờ đến 6 tuần sau sinh** ở phụ nữ có hoặc không có tiền sử tiền sản giật trước đó.[^3][^4]
   - Biểu hiện bằng tăng huyết áp mới xuất hiện kèm đau đầu dữ dội, mờ mắt hoặc phù phổi.
   - Xử trí: Nhập viện cấp cứu, truyền $MgSO_4$ dự phòng co giật trong 24 giờ và dùng thuốc hạ áp theo phác đồ.[^3][^4]
...
Tuyên bố khoa học của Hiệp hội Tim mạch Hoa Kỳ (_AHA Circulation 2022_) nhấn mạnh tiền sản giật không chỉ là bệnh lý ngắn hạn trong thai kỳ mà còn là một **yếu tố nguy cơ độc lập mạnh mẽ của bệnh lý tim mạch và chuyển hóa trong suốt cuộc đời người mẹ**.[^2]

_Bảng "Nguy cơ tim mạch lâu dài ở phụ nữ có tiền sử Tiền sản giật". Nguồn: AHA Circulation (2022)_.[^2]
